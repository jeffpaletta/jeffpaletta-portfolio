...
var clicked = false;
var position = [[0,0],[0,0],[0,90],[0,60],[20,100],[90,0],[60,0],[100,10],[50,0],[30,0],[0,20],[0,5],[50,100],[80,0],[50,100],[0,30],[0,50],[30,90],[10,100]];
characters = ['&#9786;','&#9785;','&#9788;','&#9730;','&#9756;','&#9992;','&#9988;','&#9996;','&#9998;','&#9680;','&#9096;','&#9999;','&#9814;','&#9816;','&#9775;','&#9638;','&#9682;','&#9786;'];
var navOpen = false;
...
$('nav a').mouseenter(function(e){
	...
	if(clicked === false){
		if(that.parents('li').hasClass('active') && navOpen === true){
			...
			$('.line').addClass('remove').css({width:0});
			setTimeout(function(){
				$('.remove').remove();
...
function loadLink(link, title){
	...
	$('.process').load(link + ' section', function(){
		setTimeout(function(){
			...
			$('.lines').line(prevX, prevY, newX, newY, {
				css: {height: '0', zIndex: '1', position:'fixed', color:colour},
				width: 0, style: 'solid', color: 'transparent'
			});
			...
			if(window.history && window.history.replaceState){
				history.replaceState({path:link}, null, link);
...
function hideNav(){
	$('.line:not(:first)').addClass('remove').css({width:0});
...
$('body').on('click', '.play', function(e){
	...
	$('img, .play', block).css({zIndex:'-1'}).animate({opacity:0}, 200);
